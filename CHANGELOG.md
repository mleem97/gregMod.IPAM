...
- Massenaktionen per Checkbox (Devices-, IP- und Kunden-Listen): Bulk-Bar bei Auswahl (DHCP zuweisen, Techniker, Abwählen). Sortierung weiter über klickbare Spaltenköpfe (▲▼).
