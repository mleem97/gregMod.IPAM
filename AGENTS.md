# AGENTS.md — Hinweise für KI-Agenten (gregMod.IPAM)

Repo: [https://github.com/mleem97/gregMod.IPAM](https://github.com/mleem97/gregMod.IPAM) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
